  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body upload">
        ...
        <h2>Note these when taking the pictures:</h2>
        <div class="container">
          <div class="col-md-3">
    ...
    <div class="container">
      ...
      <div id="account" class="collapse">
          ...
          <div class="statementholder">
            ...
            <button class="bluebtn" type="button" data-toggle="modal" data-target="#acknowledgemodal" name="button">Read more</button>
          ...
          <button onclick="window.location.href='approval_wrong.php'" class="bluebtn" type="button" name="button">Next</button>
