<?php
	...
	$_SESSION["loan_instalments"] = number_format(63312,0,',',' ');
	$_SESSION["repaid_in"] = 24;
	$_SESSION["interest_rate"] = 13.99;
	$_SESSION["total_repaid"] = '1 519 484';
	$_SESSION["max_loan"] = '63 312';
	$_SESSION["min_loan"] = '21 813';
...
<div class="boxed">
		...
		<div>
			<div style="margin-top: 60px;"class="need">
				...
				<h1 class="n_amount" id="monthly_instalment">63 312 Ft</h1>
				<input class="custom_range" type="range" name="monthly" min="21813" max="63312" step="1" value="63312" list="numbers">
				<p class="min_amount" id="min_monthly_instalment">21 813 Ft</p>
				<p class="max_amount" id="max_monthly_instalment">63 312 Ft</p>
			</div>
