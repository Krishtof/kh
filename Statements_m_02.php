...
<!-- form -->
    ...
    <div class="container">
      <div class="form nopadding">
        ...
        <button class="accordion" id="select_upload_button" data-toggle="collapse" data-target="">Upload ID</button>
        <div id="expenses" class="collapse in">
					<div class="form">
						<div class="container mobile_first form" style="width: 100%; padding: 0px;">
							<p>
								Take a photo of your personal ID or choose a photo from the picture gallery
							</p>
							<div class="uploadbtn">
								<img src="img/id_front.png" />
								<button onclick="window.location.href='Statements_m_02_1.html'" class="bluebtn" type="button" name="button">Take a picture of fronts side of ID</button>

							</div>
							<div class="uploadbtn">
								<img src="img/id_back.png" />
								<button onclick="window.location.href='Statements_m_02_1.html'" class="bluebtn" type="button" name="button">Take a picture of back side of ID</button>
							...
							<div class="uploadbtn" style="margin-top: 50px;">
								...
								<img src="img/id_back.png" />
								<button onclick="window.location.href='Statements_m_02_1.html'" class="bluebtn" type="button" name="button">Take a picture of Address card</button>
